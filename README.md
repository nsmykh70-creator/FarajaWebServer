...
[<img src="docs/button-download.png" width="320" alt="Скачать EXE">](https://github.com/nsmykh70-creator/FarajaWebServer/releases/latest/download/FarajaWebServerPRO.exe) ·
...
- ⏰ **Планировщик задач** — хранение команд с пометкой расписания (в этой версии — ручной запуск кнопкой «Запустить»).
...
Вкладка «Задачи»: имя, команда (например `node server.js`) и пометка
расписания (`manual` — только вручную, `0 2 * * *` — ежедневно в 2:00 как
напоминание). В этой версии задачи запускаются **вручную** кнопкой
«Запустить», авто-запуск по расписанию — в планах; вывод виден в системном логе.
